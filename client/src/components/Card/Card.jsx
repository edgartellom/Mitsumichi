...
const Card = ({ data }) => {
  ...
  // console.log(data)
  return (
    <div className=" bg-[#0006] flex flex-col w-80 m-4 rounded-2xl">
      <div className="relative p-2   flex flex-wrap mx-auto justify-center">
        <div className=" min-w-[340px]flex flex-col group">
          <div className=" rounded-lg h-48 md:h-56 lg:h-[24rem] w-full bg-white border-2 border-white flex items-center justify-center text-white text-base mb-3 md:mb-5 overflow-hidden relative">
            <img
              src={imageUrl[0]}
              className=" scale-100 group-hover:scale-110 transition-all duration-400"
              alt=""
              width={500}
            />
          ...
          <p className="mb-4 text-sm md:text-sm text-center font-bold">
            USD {precio}
          </p>
