...
const VisitCard = () => {
  ...
  useEffect(() => {
    ...
    const data = [45, 52, 38, 45, 19, 23, 2];
    ...
    <div className="bg-white rounded-lg shadow-lg -mt-4 p-2 w-[400px] scale-[0.9] duration-300 hover:scale-[0.91] hover:bg-[#fff4ee]">
      <div className="flex flex-col">
        <div className="flex justify-between">
          <h2 className="text-2xl uppercase text-gray-800 mb-2">
            registrios de usuarios
          </h2>
        ...
        <p className="text-gray-600 mb-1 capitalize">88 registros nuevos</p>
