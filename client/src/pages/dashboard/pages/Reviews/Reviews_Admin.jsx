...
const Reviews_Admin = () => {
  ...
  return (
    <div className="min-h-full bg-slate-100 p-4">
      <table className="w-full rounded-md shadow-sm shadow-[#252525] overflow-hidden">
        <thead className="h-[40px] bg-gradient-to-r from-gray-400 via-gray-300 to-gray-400">
          {currentReviews.length === 0 ? null : (
            <tr>
        ...
        {currentReviews.length === 0 ? (
          <h1 className="p-4 uppercase text-center text-red-600 font-semibold">
            No exixten reviews con esta DESCRIPCIÓN
          </h1>
        ) : (
          <tbody>
